...
public class AgentFactory {
	...
	//====================================================================================================================================================================
	//Tah: Pick up the number of each type of agents
	...
	private void createRandomAgents(boolean dummy) throws AgentCreationException, ClassNotFoundException, InstantiationException, IllegalAccessException {
		...
		while (agentsCreated < numAgents) {
			...
			while (i.hasNext() && agentsCreated < numAgents) {
				...
				//===========================================================================================================================================================
				IAgent a = new Student(); //Tah: Create a new agent (Student)
	...
	private void createPointAgents(boolean dummy) throws AgentCreationException {
		...
		for (IAgent a : ContextManager.getAllAgents()) {
			...
			//================================================================================================================================================================
			nbrDefaultAgent=numAgents; // Tah: pick up the total of defaultAgent
